				...
				<div class="col-lg-4 col-md-6 mb-20">
					<div class="card-box height-100-p pd-20 min-height-200px">
						<div class="d-flex justify-content-between pb-10">
							<div class="h5 mb-0">My Objectives</div>
						...
						<div class="user-list">
							<ul>
								<?php
		                         ...
		                         $query = mysqli_query($conn,"select * from employee_objectives e inner join evaluation_periods p on e.period=p.code where p.status=1 and e.user_id='$user_id'") or die(mysqli_error());
								...
								<li class="d-flex align-items-center justify-content-between">
									<div class="name-avatar d-flex align-items-center pr-2">
										...
										<div class="txt">
												<div class="font-16 weight-500" data-color="#000"><?php echo $row['objective_code']; ?></div>
										</div>
									</div>
									</li>
								<?php }?>
