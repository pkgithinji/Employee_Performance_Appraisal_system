 ...
 if(isset($_POST['edit']))
{
    ...
    $result = mysqli_query($conn,"update department set DepartmentName = '$deptname' , DepartmentShortName ='$deptshortname' where id = '$get_id' ");
    if ($result) {
					...
					<div class="row">
						<div class="col-lg-4 col-md-6 col-sm-12 mb-30">
							<div class="card-box pd-30 pt-10 height-100-p">
								...
								<section>
									<?php
									$query = mysqli_query($conn,"SELECT * from department where id = '$get_id'")or die(mysqli_error());
