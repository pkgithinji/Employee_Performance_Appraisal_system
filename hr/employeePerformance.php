...
<body>
    ...
    <div class="main-container">
        ...
        <style>
            ...
            <a href="report_employeePerformance.php" class="btn btn-success export-btn"><i class="glyphicon glyphicon-print"></i> Export to PDF</a>
                                ...
                                <div class="form-background">
                                    <table id="employeeScoresTable" class="data-table table stripe">
                                        ...
                                        <tbody>
                                            ...
                                            if ($get_periodCode) {
                                                $sql="select t.*,AVG(er.agreed_score) AS avg_agreed_score, recommendation_engine(AVG(er.agreed_score))as recomm from (SELECT e.emp_id, CONCAT(e.FirstName, ' ', e.LastName) AS EmployeeName,e.supervisor_id, e.Department,u.user_id from employee e left join users u on e.emp_id=u.emp_id )t inner join employee_rating er ON t.user_id = er.evaluatee_id 
