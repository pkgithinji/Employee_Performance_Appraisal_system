 ...
 if(isset($_POST['add']))
{
	...
	$deptshortname=$_POST['departmentshortname'];
     ...
     $query = mysqli_query($conn,"select * from department where DepartmentName = '$deptname'")or die(mysqli_error());
     ...
     if ($count > 0){ 
        ...
        $query = mysqli_query($conn,"insert into department (DepartmentName, DepartmentShortName)
