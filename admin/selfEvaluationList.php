					...
					<div class="page-header">
						<div class="row">
							<div class="col-md-6 col-sm-12">
								<div class="title">
									<h4>Available Evaluation Periods</h4>
								</div>
								<nav aria-label="breadcrumb" role="navigation">
									<ol class="breadcrumb">
										<li class="breadcrumb-item"><a href="admin_dashboard.php">Dashboard</a></li>
										<li class="breadcrumb-item active" aria-current="page">Allowed Evaluation Periods</li>
									</ol>
								</nav>
							</div>
						</div>
						...
						<div class="col-lg-8 col-md-6 col-sm-12 mb-30">
							<div class="card-box pd-30 pt-10 height-100-p">
								<h2 class="mb-30 h4">List of Available Evaluation Periods</h2>
								<div class="pb-20">
									<table class="data-table table stripe ">
										...
										<tbody>
											...
											<?php $sql = "SELECT * from evaluation_periods";
											...
											<tr>
												...
												<td>
													<div class="table-actions">
														<a href="selfEvaluation.php?view=<?php echo htmlentities($result->code);?>" data-color="#265ed7">Evaluate</a>
