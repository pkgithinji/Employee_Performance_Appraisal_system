			...
			<div class="row pb-10">
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $query_reg_hod = mysqli_query($conn,"select * from designation ")or die(mysqli_error());
						 $count_designations = mysqli_num_rows($query_reg_hod);
						 ?>

						<div class="d-flex flex-wrap">
							<div class="widget-data">
								<div class="weight-700 font-24 text-dark"><?php echo($count_designations); ?></div>
				...
				<div class="col-xl-3 col-lg-3 col-md-6 mb-20">
					<div class="card-box height-100-p widget-style3">
						...
						<?php 
						 $query_departs = mysqli_query($conn,"select * from department ")or die(mysqli_error());
						 $count_depts = mysqli_num_rows($query_departs);
						 ?>

						<div class="d-flex flex-wrap">
							<div class="widget-data">
								<div class="weight-700 font-24 text-dark"><?php echo($count_depts); ?></div>
					...
					<table class="data-table table stripe hover nowrap">
						...
						<tbody>
							<tr>
								 ...
								 <?php
		                         $teacher_query = mysqli_query($conn,"select * from employee LEFT JOIN department ON employee.Department = department.DepartmentShortName where status=1 ORDER BY employee.emp_id") or die(mysqli_error());
